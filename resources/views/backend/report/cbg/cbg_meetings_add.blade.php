                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <form id="techForm" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="meeting_type" class="form-control" id="meeting_type"
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="meeting_venue" class=" font-weight-bold">Venue<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="meeting_venue" id="meeting_venue"
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="number" name="meeting_date" id="meeting_date" class="form-control date"
