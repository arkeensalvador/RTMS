            ...
            <div class="row files">
                <div class="col-lg-7">
                    ...
                    <div class="strategic card">
                        ...
                        {{-- card body start --}}
                        <div class="card-body">
                            <form action="{{ URL::to('/sub-project-upload-file') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @if (count($errors) > 0)
                                ...
                                <input type="text" class="form-control" name="projectID"
                                    value="{{ $sub_project->projectID }}" placeholder="projectID" hidden readonly required
                                    autocomplete="false">

                                <input type="text" class="form-control" name="subprojectID" value="{{ $sub_project->id }}"
                                ...
                                <input type="text" class="form-control" name="uploader_agency"
                                    value="{{ auth()->user()->agencyID }}" placeholder="subprojectID" hidden readonly required
                                    autocomplete="false">
