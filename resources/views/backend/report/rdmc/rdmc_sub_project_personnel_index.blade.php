...
@section('content')
                                                    ...
                                                    <tr>
                                                        <td class="append">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ Route::input('projectID') }}" placeholder=""
                                                                hidden readonly required autocomplete="false">

                                                            <input type="text" class="form-control"
                                                                name="moreFields[0][subprojectID]"
                                                                value="{{ Route::input('id') }}" placeholder="" hidden
    ...
    <script type="text/javascript">
        ...
        $("#add-btn").click(function() {
            ...
            <tr>
                <td class="append">
                    <input type="text" class="form-control" name="moreFields[` + i + `][projectID]" value="{{ Route::input('projectID') }}" 
                    placeholder="Program ID" hidden readonly required autocomplete="false">
                    <input type="text" class="form-control" name="moreFields[` + i + `][subprojectID]" value="{{ Route::input('id') }}" 
                    placeholder="Program ID" hidden readonly required autocomplete="false">
