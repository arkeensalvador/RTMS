        ...
        <div class="strategic row">
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-success progress-bar-striped" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    {{-- card body start --}}
                    <div class="card-body">
                        <form role="form" id="regiration_form" action="{{ url('update-project/'.$projects->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $projects->project_fund_code }}" name="project_fund_code" class="form-control" placeholder="Enter ...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="project_status" id="" class="form-control">
                                                <option value="New" {{ 'New' == $projects->project_status ? 'selected' : '' }}>New
                                                </option>
                                                <option value="On-going" {{ 'On-going' == $projects->project_status ? 'selected' : '' }}>
                                                    On-going</option>
                                                <option value="Terminated" {{ 'Terminated' == $projects->project_status ? 'selected' : '' }}>
                                                    Terminated</option>
                                                <option value="Completed" {{ 'Completed' == $projects->project_status ? 'selected' : '' }}>
                                                    Completed</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="project_category" id="" class="form-control">
                                                <option value="Research Category" {{ 'Research Category' == $projects->project_category ? 'selected' : '' }}>
                                                    Research Category</option>
                                                <option value="Development Category" {{ 'Development Category' == $projects->project_category ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <select name="project_agency" id="agency" class="form-control agency">
                                                ...
                                                <option value="{{ $key->abbrev }}" {{ $key->abbrev == $projects->project_agency ? 'selected' : '' }}>
                                                    {{ $key->agency_name }} -
                                                    ({{ $key->abbrev }})
                                                    </b>
                                                </option>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly class="form-control" id="agencyAbbrev" style="border: none;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="month" value="{{ $projects->project_start_date }}" class="form-control" name="project_start_date" autocomplete="false">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="month" value="{{ $projects->project_end_date }}" class="form-control" name="project_end_date" autocomplete="false">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="month" value="{{ $projects->project_extend_date }}" class="form-control" name="project_extend_date" autocomplete="false">
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $projects->project_leader }}" name="project_leader" class="form-control" placeholder="Program Leader" list="leaderdtlist">
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $projects->project_assistant_leader }}" name="project_assistant_leader" class="form-control" placeholder="Program Leader" list="assisdtlist">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="project_description" id="" cols="30" rows="5" style="resize: none;" class="form-control">{{ $projects->project_description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ $projects->project_approved_budget }}" name="project_approved_budget" type="text" class="form-control" id="numin">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ $projects->project_budget_year }}" name="project_budget_year" type="text" class="form-control" id="numin2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
