                            ...
                            <form id="projectForm" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-4 form-group" hidden>
                                    <label for="fund_code" class="font-weight-bold">Project ID<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="projectID" value="{{ $projects->id }}" class="form-control"
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="fund_code" class="font-weight-bold">Project Title<span
                                            class="text-danger">*</span></label>
                                    <input type="text" value="{{ $projects->project_title }}" class="form-control"
                                        id="fund_code" placeholder="Input Trust Fund Code" readonly required>
                                    <div class="valid-feedback"></div>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="sub_project_fund_code" class="form-control" id="fund_code"
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" id="program_title" name="sub_project_title" style="height: 100px"
                                        placeholder="Enter project/study title" required></textarea>
                                    <div class="invalid-feedback">Missing project title</div>
                                </div>

                                <div class="col-md-12 form-group">
                                    <label for="program_description" class=" font-weight-bold">Sub Project/Study
                                    ...
                                    <textarea class="form-control" name="sub_project_description" id="program_description" style="height: 100px"
                                        placeholder="Project/study brief description" required></textarea>
                                ...
                                <div class="col-md-4 form-group">
                                    <label for="start_date" class=" font-weight-bold">Duration<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="sub_project_duration" class="form-control date-range"
                                ...
                                <div class="col-md-4 form-group float-right">
                                    <a href="{{ url('sub-projects-view/' . $projects->id) }}"
                        ...
                        Swal.fire({
                            ...
                            if (result.dismiss) {
                                window.location.href =
                                    "{{ URL::to('sub-projects-view/' . $projects->id) }}";
                            }
                        })
                    },
                    error: function(data) {
