                            ...
                            <form id="techForm" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" name="ttp_title" id="ttp_title" rows="3" placeholder="Enter ..."
                                        style="resize: none;" required>{{ $all->ttp_title }}</textarea>
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" name="ttp_end_date" value="{{ $all->ttp_end_date }}"
                                        class="form-control date" id="ttp_end_date" placeholder="Enter end date" required>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" name="ttp_priorities" id="ttp_priorities" rows="3" placeholder="Enter ..."
                                        required>{{ $all->ttp_priorities }}</textarea>
            ...
            $('#techForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'TTP Updated Successfully',
