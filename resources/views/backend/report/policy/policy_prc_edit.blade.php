                        ...
                        <div class="d-flex mt-3">
                            <form id="programForm" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <select name="prc_agency" class="form-control agency" required>
                                        ...
                                        @foreach ($agency as $key)
                                            <option value="{{ $key->abbrev }}"
                                                {{ $key->abbrev == $all->prc_agency ? 'selected' : '' }}>
                                                {{ $key->agency_name }}
                                                </b></option>
                                        @endforeach
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="prc_author" value="{{ $all->prc_author }}"
                                        class="form-control" placeholder="Enter author" required>
