                            ...
                            <form role="form" id="regiration_form" action="{{ url('add-programs') }}" method="POST"
                                ...
                                <fieldset>
                                    ...
                                    <input type="text" hidden readonly class="form-control" name="programID"
                                        placeholder="Program ID" value="<?php echo substr(md5(microtime()), 0, 10); ?>" autocomplete="false">
                                    ...
                                    <div class="form-group row">
                                        <label for="program_title" required
                                            ...
                                            Title</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" required name="program_title" style="font-weight: bold;" placeholder="Program Title"
                                                autocomplete="false" id="" cols="200" rows="3"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" required name="description" style="font-weight: bold;" placeholder="Program Description"
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control" name="fileupload1"
                                                required="required" id="file-upload1" disabled>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="radio-input">
                                                ...
                                                <label class="upl">
                                                    <input type="radio" id="value-2" checked name="moa"
                                                        value="0">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="radio-input">
                                                ...
                                                <label class="upl">
                                                    <input type="radio" id="value-4" checked name="lib"
                                                        value="0">
                                                    <span>Not Available</span>
                                                </label>
                                                <span class="sel"></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control" name="fileupload3"
                                                required="required" id="file-upload3" disabled>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="radio-input">
                                                ...
                                                <label class="upl">
                                                    <input type="radio" id="value-6" checked name="ntp"
                                                        value="0">
                                                    <span>Not Available</span>
                                                </label>
                                                <span class="sel"></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control" name="fileupload4"
                                                required="required" id="file-upload4" disabled>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="radio-input">
                                                ...
                                                <label class="upl">
                                                    <input type="radio" id="value-8" checked name="tr"
                                                        value="0">
                                                    <span>Not Available</span>
                                                </label>
                                                <span class="sel"></span>
