    ...
    public function meeting_add(Request $request)
    {
        $request->validate(
            [
                ...
                'meeting_host' => 'required',
            ],
            [
                'meeting_type.required' => 'Type is required!',
                'meeting_venue.required' => 'Venue is required!',
                'meeting_date.required' => 'Date is required!',
                'meeting_host.required' => 'Host is required!',
            ],
        );
