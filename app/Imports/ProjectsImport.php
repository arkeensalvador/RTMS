...
class ProjectsImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        return new Projects([
            ...
            'project_start_date' => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($row['project_start_date'])->format('Y-m-d'),
            'project_end_date' => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($row['project_end_date'])->format('Y-m-d'),
